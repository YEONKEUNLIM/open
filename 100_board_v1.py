...
def kakao_login(m):
    if m :
        ...
        ##browser.find_element(By.ID, "id_email_2").send_keys("phonNumber")
        ##browser.find_element(By.ID,"id_password_3").send_keys("pw")
       
        browser.find_element(By.ID, "input-loginKey").send_keys("phonNumber")
        browser.find_element(By.ID,"input-password").send_keys("pw!!!")
        sleep(1)
        print("로그인")
